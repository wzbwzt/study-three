...
const base = () => {
  ...
  const controls = new OrbitControls(camera, view1Elem as HTMLCanvasElement);
  ...
  const controls2 = new OrbitControls(camera2, view2Elem as HTMLCanvasElement);
...

  {
    const render = () => {
      ...
      {
        const aspect = setScissorForElement(view1Elem as Element);
      ...
      {
        const aspect = setScissorForElement(view2Elem as Element);
